      ...
      <div className='rounded-xl w-70 p-4  border border-[#e1e1e1]'>
        <div className='rounded-xl w-full bg-gray-200 outline-1 outline-[#f4f4f4] '>
          {/* <div className=' p-4 w-4 bg-white'></div> */}
            <div className=' w-full justify-center relative'>
              ...
              <img src={product.img} alt="" className='rounded-xl h-62 w-full object-cover object-center' />
       ...
       <div className='max-w-fit space-y-1 mt-1 mb-1'>
        ...
        <h1 className='text-2xl font-bold'>
          ${product.sellingPrice} <span className='text-gray-400 text-xl font-normal line-through '>${product.mrp}</span>
        </h1>
       </div>
       <div className='flex justify-center'>
       <button className=' rounded-xl w-full mt-1 mb-1 py-2 bg-blue-800 hover:bg-blue-950 transition-colors text-white items-center' onClick={()=> {addToCart(product)}}>Add To Cart</button>
        </div>
        </div>
    </div>
  )
